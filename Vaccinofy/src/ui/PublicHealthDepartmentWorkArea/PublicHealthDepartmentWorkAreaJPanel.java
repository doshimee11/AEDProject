...
public class PublicHealthDepartmentWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public PublicHealthDepartmentWorkAreaJPanel(JPanel userProcessContainer, PublicHealthEnterprise publicHealthEnterprise, UserAccount userAccount, Ecosystem system) {
        initComponents();
    ...
    private void manageOrderJButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageOrderJButton1ActionPerformed
        ManageVaccineOrderJPanel manageVaccineOrderJPanel = new ManageVaccineOrderJPanel(userProcessContainer, userAccount, system, publicHealthEnterprise);
